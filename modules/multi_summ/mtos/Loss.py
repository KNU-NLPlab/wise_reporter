...
class NMTLossCompute(LossComputeBase):
    ...
    def _compute_loss(self, batch, output, target ):
        ...
        #print("loss line:187 aggregated_weight", aggregated_weight)
        #print("loss line:188 true_weight", true_weight)
        #print("loss line:189 target", target)
        ...
        #loss = self.criterion(scores, gtruth) + 0.2 * self.mseloss(aggregated_weight, true_weight)
