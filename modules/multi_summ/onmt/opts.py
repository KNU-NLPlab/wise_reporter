...
def model_opts(parser):
    ...
    group.add('--transformer_copy', '-transformer_copy', action='store_true')
...
def preprocess_opts(parser):
    ...
    group.add('--korean_subword', '-korean_subword', action='store_true')
    group.add('--korean_morphs', '-korean_morphs', action='store_true')
    group.add('--bert', '-bert', action='store_true')
...
def translate_opts(parser):
    ...
    group.add('--tokenized_bert', '-tokenized_bert', action='store_true')
    group.add('--korean_subword', '-korean_subword', action='store_true')
    group.add('--korean_morphs', '-korean_morphs', action='store_true')
    group.add('--bert', '-bert', action='store_true')
